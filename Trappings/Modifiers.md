...
Infusions can only be applied to weapons, and other objects that can be used for attacking. If applied to a natural weapon, then the infusion only lasts 7 days.
